...
<p>
    ...
    estudiante del <?= $student->tenant->program->getAreaPrintLabel() ?>,
    CULMINÓ las actividades inherentes a la prestación del Servicio Comunitario
    según lo establecido en la LEY DE SERVICIO COMUNITARIO DEL ESTUDIANTE DE EDUCACIÓN SUPERIOR y sus
    REGLAMENTOS, a través de la ejecución del Proyecto: <strong><?= $project->name ?></strong>,
...
<p>
    ...
    los Morros; a los <?= $endingStage->created->day ?> días del mes de <?= $this->App->month($endingStage->created->month) ?> de <?= $endingStage->created->year ?>.
</p>
